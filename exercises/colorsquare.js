...
class ColorSquare{
	...
	*/
	constructor(colors, currentColor, classString){
		this.colors = colors;
	...
	*/
	...
	handleClick(){
		...
		this.domElement.css("background-color", this.colors[this.currentColor]);
	...
	*/
	render(){
		this.domElement = $("<div>");
		this.domElement.addClass(this.classString);
		this.domElement.on("click", this.handleClick);
		this.domElement.css("background-color", this.currentColor);
